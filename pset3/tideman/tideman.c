...
void sort_pairs(void)
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        for (int j = 0; j < pair_count; j++)
        {
            ...
            {
                temp_pair[i].winner = pairs[i].winner;
                temp_pair[i].loser = pairs[i].loser;
                pairs[i].winner = pairs[j].winner;
                pairs[i].loser = pairs[j].loser;
                pairs[j].winner = temp_pair[i].winner;
                pairs[j].loser = temp_pair[i].loser;
            }
        }
    }
    return;
